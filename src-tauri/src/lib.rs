...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
        ...
        // Knowledge Graph
        modules::knowledge::commands::create_knowledge_node,
        modules::knowledge::commands::get_knowledge_node,
        modules::knowledge::commands::get_project_knowledge_nodes,
        modules::knowledge::commands::search_knowledge_nodes,
        modules::knowledge::commands::update_knowledge_node,
        modules::knowledge::commands::delete_knowledge_node,
        modules::knowledge::commands::create_knowledge_edge,
        modules::knowledge::commands::get_knowledge_edges,
        modules::knowledge::commands::delete_knowledge_edge,
        modules::knowledge::commands::get_knowledge_log,
